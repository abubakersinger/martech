...
const footerLinks = {
  Content: [
    { name: "Blog", href: "/blog" },
    { name: "GTM Guides", href: "/blog?category=gtm" },
    { name: "App Tracking", href: "/blog?category=app-tracking" },
    { name: "Event Mapping", href: "/blog?category=event-mapping" },
  ],
  Services: [
    { name: "GTM Audit", href: "/services#gtm-audit" },
    { name: "Tracking Setup", href: "/services#tracking-setup" },
    { name: "Event Mapping", href: "/services#event-mapping" },
